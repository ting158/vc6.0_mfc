...
BEGIN_MESSAGE_MAP(CAccessTestApp, CWinApp)
	//{{AFX_MSG_MAP(CAccessTestApp)
...
BOOL CAccessTestApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CAccessTestDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CAccessTestView));
...
void CAccessTestApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
/////////////////////////////////////////////////////////////////////////////
// CAccessTestApp message handlers
