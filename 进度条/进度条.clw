...
Type=0
HeaderFile=进度条.h
ImplementationFile=进度条.cpp
Filter=N

[CLS:CMyDoc]
Type=0
HeaderFile=进度条Doc.h
ImplementationFile=进度条Doc.cpp
Filter=N

[CLS:CMyView]
Type=0
HeaderFile=进度条View.h
ImplementationFile=进度条View.cpp
Filter=C
